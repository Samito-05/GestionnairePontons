...
# Lockout par username (pas par IP : derrière Cloudflare Tunnel, toutes les
# requêtes arrivent avec l'IP du conteneur tunnel — un lockout IP bloquerait
# tout le monde).
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'pontons.context_processors.user_role',
            ],
        },
    },
]
